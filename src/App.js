...
class App extends Component {
  ...
  deleteHistory = id => {
    ...
    const filteredData = historyDetailsList.filter(eachObj => eachObj.id !== id)
    this.setState({historyDetailsList: filteredData})
  }

  render() {
    const {searchInput, historyDetailsList} = this.state

    const searchResults = historyDetailsList.filter(eachObj =>
